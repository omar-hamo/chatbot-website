...
const SignUp = () => {
  ...
  const validationSchema = Yup.object().shape({
    name: Yup.string().min(3, "tooshort").required("required"),
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-black flex-col ">
        <div class="h-auto w-auto md:w-auto mt-6  rounded-2xl bg-gradient-to-r from-blue-500 from-10% via-pink-500 via-90% to-orange-500 to-99% p-0.5">
          <div className="bg-gray-950 text-white p-10  rounded-2xl shadow-lg w-96 md:w-[500px] opacity-90">
            ...
            <h2 className="text-4xl font-semibold text-center mb-1">Sign Up</h2>
            <p className="text-center mb-4">Create Your Free Account</p>
            <div className="mb-4">
              <Button
            ...
            >
              {(props) => (
                <Form>
                  ...
                  <button className="w-full py-2 text-white bg-[#FF9478] rounded-lg">
                    {props.isSubmitting
                      ? "Loading..."
            ...
            <p className="text-center mt-2 text-gray-400 text-xs">
              ...
              <a className="underline text-gray-500 text-base">
                Terms Of Service.
              </a>
            </p>
          </div>
